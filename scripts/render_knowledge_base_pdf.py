...
SOURCE = ROOT / "docs" / "CodeEvo知识库.md"
OUTPUT = ROOT / "output" / "pdf" / "CodeEvo知识库.pdf"
...
def footer(canvas, document) -> None:
    ...
    canvas.drawString(LEFT, 6.6 * mm, "CodeEvo PR Reviewer 知识库")
...
def build() -> None:
    ...
    document = SimpleDocTemplate(
        ...
        topMargin=TOP,
        bottomMargin=BOTTOM,
        title="CodeEvo PR Reviewer 知识库",
        author="CodeEvo",
        subject="CodeEvo 项目知识库",
    )

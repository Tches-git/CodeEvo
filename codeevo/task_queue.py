...
class TaskQueue:
    STREAM = "codeevo:review:stream"
    DLQ = "codeevo:review:dlq"
    GROUP = "codeevo-workers"
    ...
    def __init__(
        ...
        self._executor = ThreadPoolExecutor(max_workers=workers, thread_name_prefix="codeevo-worker")
        self._redis = None
